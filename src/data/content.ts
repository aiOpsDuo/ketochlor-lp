...
export const HERO = {
  ...
  subheading:
    'A dupla ação que a diretriz ISCAID (2025) recomenda, na concentração ideal¹ — agora com tecnologia exclusiva de suporte ao microbioma cutâneo.',
...
export const PROBLEMA = {
  ...
  paragraphs: [
    'A Dermatite Atópica Canina (DAC) raramente aparece sozinha. A ruptura da barreira cutânea abre espaço para infecções secundárias — bacterianas e fúngicas — que se retroalimentam com o prurido e a inflamação de base.',
...
export const PROVA_AUTORIDADE = {
  ...
  stats: [
    { value: '70%', label: 'dos cães com melhora clínica significativa dos sinais avaliados', pct: 70 },
    { value: '63%', label: 'redução média do prurido relatado pelos tutores', pct: 63 },
    { value: '100%', label: 'dos casos com formulação dentro da concentração recomendada pelo ISCAID', pct: 100 },
  ],
...
export const PROTOCOLO = {
  ...
  closing:
    'Ketochlor® é o único do mercado com garantia de estabilidade por 12 meses após aberto — o tratamento completo, sem interrupção por perda de eficácia e sem desperdício para o tutor.',
}
  ...
  items: [
    {
      ...
      corpo: 'Cetoconazol com 7-14x mais penetração no estrato córneo e efeito residual prolongado²',
    },
    {
      titulo: 'Potência antisséptica otimizada',
      corpo: '2,3% de Clorexidina, dentro da concentração recomendada pelo ISCAID¹',
    },
    {
      titulo: 'Tecnologia exclusiva SIS',
      corpo: 'Estimula as defesas naturais da pele — essencial para o paciente atópico⁴',
    },
    {
      titulo: 'Estabilidade incomparável',
      corpo: '12 meses de validade em uso — tratamento completo, sem desperdício',
    },
  ],
}
...
export const MATERIAL_TECNICO = {
  ...
  heading: 'O material técnico completo sobre Ketochlor® está a um cadastro de distância.',
  subheading:
    'Indicação, mecanismo de ação, estudo clínico na íntegra e protocolo de prescrição — acesso imediato após o cadastro.',
  ctaLabel: 'QUERO ACESSAR O MATERIAL TÉCNICO COMPLETO',
...
export const FAQS: FaqItem[] = [
  {
    question: 'O estudo do Ketochlor® é publicado em periódico revisado por pares?',
    answer:
      'Os dados do estudo com 41 cães são internos Virbac ("data on file"). O racional científico dos ativos está apoiado em literatura publicada e revisada — ISCAID (2025), Pershing et al. (1994), Gupta et al. (2025) e Ferreira et al. (2023).',
  },
  {
    question: 'Ketochlor® substitui o tratamento sistêmico da DAC?',
    answer:
      'O material oficial não faz essa afirmação. Ketochlor® atua sobre os sinais clínicos das infecções secundárias associadas à DAC, dentro de uma linha Virbac mais ampla.',
  },
  {
    question: 'Qual a diferença entre usar Ketochlor® e o Hexadene Spherulites®?',
    answer:
      'A indicação varia por fenótipo: Hexadene Spherulites® para o agudo; Ketochlor® para o crônico, com infecção recorrente por BOG e MOG.',
  },
  {
    question: 'Por que a estabilidade de 12 meses após aberto importa clinicamente?',
    answer:

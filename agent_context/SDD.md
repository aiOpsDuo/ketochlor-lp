...
| **T2 — Injetor de SEO** | Intercepta a requisição do documento HTML, insere os metadados e devolve. | Função de borda da plataforma de hospedagem escolhida na implantação |

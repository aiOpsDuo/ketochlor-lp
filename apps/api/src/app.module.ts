...
@Module({
  ...
  // `MetadataModule`/`MediaModule`/`LeadsModule` listados explicitamente aqui
  // (peers de `ContentModule`, um módulo por domínio — SDD § Camadas e padrão
  ...
  imports: [HealthModule, AuthModule, MetadataModule, ContentModule, MediaModule, LeadsModule],
})
